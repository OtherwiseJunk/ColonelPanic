...
{
    [Group("scrum"), RequireColPermission("scrum"), RequireChannelConfiguration("scrum"), Summary("A module which provides weekly reminders to users who haven't submitted an update.")]
